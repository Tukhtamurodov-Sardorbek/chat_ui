...
class RenderSliverStickyHeader extends RenderSliver with RenderSliverHelpers {
  ...
  void performLayout() {
    ...
    final double headerPaintExtent = calculatePaintOffset(
      constraints,
      from: 0.0,
      to: headerExtent,
    );
    final double headerCacheExtent = calculateCacheOffset(
      constraints,
      from: 0.0,
      to: headerExtent,
    );
    ...
    if (child == null) {
      ...
      child!.layout(
        constraints.copyWith(
          ...
          overlap:
              math.min(headerExtent, constraints.scrollOffset) +
    ...
    if (header != null) {
      ...
      if (header
          is RenderConstrainedLayoutBuilder<
            BoxValueConstraints<SliverStickyHeaderState>,
            RenderBox
          >) {
        final double headerScrollRatioClamped = headerScrollRatio.clamp(
          0.0,
          1.0,
        );

        final SliverStickyHeaderState state = SliverStickyHeaderState(
